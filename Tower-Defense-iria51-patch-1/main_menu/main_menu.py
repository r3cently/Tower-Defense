...
class MainMenu:
    def __init__(self, win):
        ...
        self.bg = pygame.transform.scale(self.bg, (self.width + 1000, self.height + 1000))
        self.start_btn = pygame.image.load(os.path.join("game_assets/sistem" + "/button_play.png")).convert_alpha()
        self.logo = pygame.transform.scale(pygame.image.load(os.path.join("game_assets/sistem", "logo.png")).convert_alpha(), (450, 450))
        self.win = win
